        ...
        <div class="row">
            <div class="col-md-3">
                <div class="block-content">
                    <a href="/factura/crearFactura" style="width: 100%" class="app-widget-button app-widget-button-lg"><span class="icon-file-add"></span> Nueva factura</a>
                </div>
            ...
            <div class="col-md-3">
                <div class="block-content">
                    <a href="#" style="width: 100%" class="app-widget-button app-widget-button-lg"><span class="icon-users"></span> Clientes</a>
                </div>
